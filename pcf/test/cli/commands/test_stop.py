""" Tests for pcf stop command """

import pytest
from mock import patch
from pcf.cli.commands.stop import stop
...
class TestStop:
    ...
    def test_stop_from_default_config_file(
        ...
        with cli_runner.isolated_filesystem():
            ...
            result = cli_runner.invoke(stop, [self.particle_pcf_name])
